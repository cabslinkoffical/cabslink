...
const TITLE = "Locations Explorer — Cabslink UK Travel";
const DESC =
  "Browse every UK city, town, airport, station, university, hospital and attraction Cabslink serves. Search or explore by region, category or A–Z.";
...
export const Route = createFileRoute("/explore/")({
  ...
  notFoundComponent: () => (
    <main className="container-x py-16 text-center">
      <h1 className="text-2xl font-bold text-[var(--navy)]">Not found</h1>
    </main>
  ),
});
...
function ExplorePage() {
  ...
  return (
    <main className="container-x py-10">
      <Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Locations Explorer", href: "/explore" }]} />

      {/* Hero */}
      <section className="mt-6 rounded-3xl bg-gradient-to-br from-[var(--navy)] to-[#1a2749] px-6 py-14 text-white sm:px-12">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-[var(--gold)]">Locations Explorer</p>
      ...
      <section className="mt-14">
        <FaqBlock
          items={[
            { q: "Can I book any location listed here?", a: "Yes. Every destination in the explorer is instantly bookable — even ones without a dedicated page. Start on our booking page and search the same name." },
            ...
            { q: "Do you cover the whole UK?", a: "Yes — we cover every UK postcode. The explorer highlights named regions, but our booking system accepts any address." },
          ]}
        />
      </section>
