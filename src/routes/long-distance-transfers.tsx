...
const content = SERVICE_PILLARS["long-distance-transfers"]!;
const URL = "https://cabslink.com/long-distance-transfers";

export const Route = createFileRoute("/long-distance-transfers")({
  head: () => ({
    meta: [
