...
const content = SERVICE_PILLARS["university-transfers"]!;
const URL = "https://cabslink.com/university-transfers";

export const Route = createFileRoute("/university-transfers")({
  head: () => ({
    meta: [
