...
function PostEditor() {
  ...
  const save = useMutation({
    ...
    onSuccess: (r: any) => {
      ...
      if (isNew && r?.id) router.navigate({ to: "/cabs-booking-pannel/blog/$id", params: { id: r.id } });
    },
  ...
  const del = useMutation({
    ...
    onSuccess: () => { toast.success("Deleted"); router.navigate({ to: "/cabs-booking-pannel/blog" }); },
