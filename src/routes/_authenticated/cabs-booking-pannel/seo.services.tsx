...
export const Route = createFileRoute("/_authenticated/cabs-booking-pannel/seo/services")({
  head: () => ({
    meta: [
      { title: "Seo › Services — Cabslink Admin" },
      { name: "description", content: "Cabslink staff console: seo › services." },
