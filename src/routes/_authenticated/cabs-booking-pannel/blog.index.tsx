...
export const Route = createFileRoute("/_authenticated/cabs-booking-pannel/blog/")({
  head: () => ({
    meta: [
  ...
  return (
    <div>
      <PageHeader title="Content Hub" description="Manage blog posts, categories, tags and authors.">
        <Link to="/cabs-booking-pannel/blog/categories"><Button variant="outline" size="sm"><Folder className="size-4 mr-1.5" />Categories</Button></Link>
        <Link to="/cabs-booking-pannel/blog/tags"><Button variant="outline" size="sm"><Tag className="size-4 mr-1.5" />Tags</Button></Link>
        <Link to="/cabs-booking-pannel/blog/authors"><Button variant="outline" size="sm"><User className="size-4 mr-1.5" />Authors</Button></Link>
        <Button size="sm" onClick={() => router.navigate({ to: "/cabs-booking-pannel/blog/$id", params: { id: "new" } })}>
              ...
              {filtered.map((r) => (
                <tr key={r.id} className="border-t border-border">
                  ...
                  <td className="px-3 py-2 text-right whitespace-nowrap">
                    ...
                    <Link to="/cabs-booking-pannel/blog/$id" params={{ id: r.id }}>
