...
export const Route = createFileRoute("/_authenticated/cabs-booking-pannel/seo/pages")({
  head: () => ({
    meta: [
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2 flex justify-between gap-2 pt-2">
                <div>
                  ...
                  {form.id && <Link to={"/cabs-booking-pannel/seo/pages/$id/sections" as any} params={{ id: form.id } as any} className="ml-2 text-xs text-primary underline">Manage sections →</Link>}
                </div>
