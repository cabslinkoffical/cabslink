...
export const Route = createFileRoute("/_authenticated/cabs-booking-pannel/seo/")({
  head: () => ({
    meta: [
...
function SeoOverview() {
  ...
  const cards = [
    { label: "Locations", value: `${data.locations.published}/${data.locations.total}`, icon: MapPin, accent: "text-info", to: "/cabs-booking-pannel/seo/locations" },
    { label: "Airports", value: `${data.airports.published}/${data.airports.total}`, icon: Plane, accent: "text-info", to: "/cabs-booking-pannel/seo/airports" },
    { label: "Services", value: `${data.services.published}/${data.services.total}`, icon: Wrench, accent: "text-warning", to: "/cabs-booking-pannel/seo/services" },
    { label: "Popular Routes", value: `${data.routes.published}/${data.routes.total}`, icon: RouteIcon, accent: "text-info", to: "/cabs-booking-pannel/seo/routes" },
    { label: "SEO Pages", value: String(data.pages.total), icon: FileText, accent: "text-success", to: "/cabs-booking-pannel/seo/pages" },
