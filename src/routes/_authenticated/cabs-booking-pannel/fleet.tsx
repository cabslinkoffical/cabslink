...
import { Plus, Edit, Trash2, Upload, Loader2, X, ChevronDown, Users, Briefcase, Clock, MapPin, Gauge, Settings2, Car } from "lucide-react";
...
export const Route = createFileRoute("/_authenticated/cabs-booking-pannel/fleet")({
  head: () => ({
    meta: [
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="rounded-lg border border-[var(--gold)]/40 bg-[var(--gold)]/10 px-4 py-3 text-sm">
        ...
        <Link to="/cabs-booking-pannel/vehicle-classes" className="underline font-medium">Vehicle Classes</Link>.
      </div>
