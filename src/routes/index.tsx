...
function CoverageSection() {
  ...
  return (
    <section className="section-y bg-white">
      <div className="container-x">
        {/* Header row — one statement of where we operate */}
        <div className="grid lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-5">
            <p className="text-[var(--navy)]/65 leading-relaxed">
        ...
        {/* Airports — balanced 4-across grid so both rows are complete */}
        ...
        {/* Towns & cities — full-width strip, no lopsided column */}
        <div className="mt-6 rounded-[24px] border border-[var(--navy)]/10 bg-[var(--surface-2)] p-6 md:p-7">
