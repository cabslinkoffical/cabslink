...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-3.5 py-3 text-white shadow-lg ring-1 ring-black/10 transition hover:scale-105 hover:shadow-xl active:scale-95 sm:bottom-6 sm:right-6"
    >
