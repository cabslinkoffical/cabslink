...
export function WhatsAppButton() {
  ...
  /** Booking flows render a sticky mobile price bar — lift the button above it. */
  const hasMobileBar = pathname.startsWith("/book");
  ...
  return (
    ...
    >
      <span className="relative flex size-6 items-center justify-center sm:size-7">
        <span className="absolute inline-flex size-full animate-ping rounded-full bg-white/40" />
        <svg viewBox="0 0 24 24" fill="currentColor" className="relative size-full">
