...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 grid size-13 place-items-center rounded-full bg-[#25D366] p-3.5 text-white shadow-lg ring-1 ring-black/10 transition hover:scale-105 hover:shadow-xl active:scale-95 sm:bottom-6 sm:right-6"
    >
      <span className="relative flex size-6 items-center justify-center">
        <span className="absolute inline-flex size-full animate-ping rounded-full bg-white/40" />
        <svg viewBox="0 0 24 24" fill="currentColor" className="size-6 relative">
