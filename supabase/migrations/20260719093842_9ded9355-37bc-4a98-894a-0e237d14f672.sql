...
REVOKE ALL ON FUNCTION public.seo_find_similar_pages(real) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.seo_find_orphan_pages() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.seo_find_similar_pages(real) TO authenticated;
GRANT EXECUTE ON FUNCTION public.seo_find_orphan_pages() TO authenticated;
